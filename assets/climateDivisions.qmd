...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="Server=storm-b.ncdc.noaa.gov; Service=port:5150; User=gis; Version=SDE.DEFAULT" type="ArcSDE Connection" name="SDE Feature Class" description="" format="" mimeType="" size=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial minz="0" maxy="49.38435900000000345" crs="EPSG:4326" maxz="0" dimensions="2" miny="24.5439399999999992" maxx="-66.95000500000000443" minx="-124.73317400000000532"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
